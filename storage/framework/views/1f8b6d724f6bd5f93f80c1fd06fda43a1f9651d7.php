...
<body>
    ...
    <table id='RLN' class="table table-striped table-bordered dt-responsive" style="width:100%">
        ...
        <tr>
            ...
            <td><?php echo QrCode::size(100)->generate($product->id); ?></td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </table>
    </div>
    <a href="<?php echo e(route('download-pdf')); ?>" class="btn btn-primary">Télécharger en PDF</a>


</body>
</html>
<?php /**PATH /var/www/html/testdd/resources/views/qrcode.blade.php ENDPATH**/ ?>