...
<body>
    ...
    <table id='RLN' class="table table-striped table-bordered dt-responsive" style="width:100%">
        ...
        <tr>
            ...
            <td><?php echo DNS1D::getBarcodeHTML($product->id, 'C39'),($product->description); ?></td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </table>
    </a>
    </div>
    <a href="<?php echo e(route('download-pdf2')); ?>" class="btn btn-primary">Télécharger en PDF</a>
</body>
</html>
<?php /**PATH /var/www/html/testdd/resources/views/codebarre.blade.php ENDPATH**/ ?>